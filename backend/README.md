...
| `KAKAO_ALLOWED_APP_IDS` | api-server | 허용할 숫자형 카카오 앱 ID 목록(쉼표 구분, 비어 있으면 로그인 거부) | 없음 |
| `KAKAO_CONNECT_TIMEOUT` | api-server | 카카오 API 연결 제한 시간 | `3s` |
| `KAKAO_READ_TIMEOUT` | api-server | 카카오 API 응답 제한 시간 | `5s` |
